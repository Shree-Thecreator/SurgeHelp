  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans flex flex-col">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto p-4 md:p-6 flex flex-col gap-8">
        ...
        {/* FEATURE 4: EMERGENCY ACTIONS GRID (4 GRADIENT CARDS) */}
        <section className="mt-2">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg font-bold text-white flex items-center gap-2">
              <Shield className="text-blue-400" /> Quick Response Actions
            </h2>
            <span className="text-xs text-slate-400">Essential field utilities</span>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            {/* 1) Survival Guides */}
             ...
             description="Access step-by-step procedures for floods, earthquakes, fire containment, and emergency shelter."
             ctaText="Read Guides"
             ctaHref="/guides"
              imageUrl="https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?auto=format&fit=crop&w=320&q=80"
              gradient="green"
/>
...
{/* 2) Call Emergency */}
<GradientCard
  badgeText="Emergency Services"
  badgeColor="#EF4444"
  title="Call Emergency"
  description="Connect directly to Police Station, Ambulance, or Fire Brigade emergency units."
  ctaText="Select Service"
  ctaHref="/emergency"
  imageUrl="https://images.unsplash.com/photo-1582139329536-e7284fece509?auto=format&fit=crop&w=320&q=80"
  gradient="orange"
/>
            ...
            {/* 3) Request Supplies */}
             <GradientCard
             badgeText="Relief Operations"
             badgeColor="#3B82F6"
             title="Request Supplies"
             description="Broadcast emergency requests for drinking water, ration packages, power banks, and essential kit drops."
             ctaText="Request Water & Food"
             ctaHref="/supplies"
             imageUrl="https://images.unsplash.com/photo-1541802645635-11f2286a7482?auto=format&fit=crop&w=320&q=80"
             gradient="purple"
/>
          ...
          {/* 4) Report Injury */}
            <GradientCard
             badgeText="Medical Priority"
             badgeColor="#F59E0B"
             title="Report Injury"
             description="Flag critical triage needs, request paramedic dispatch, or navigate to nearby active medical centers."
             ctaText="Submit Medical Triage"
              ctaHref="/injury"
             imageUrl="https://images.unsplash.com/photo-1516549655169-df83a0774514?auto=format&fit=crop&w=320&q=80"
             gradient="gray"
/>
          </div>
        </section>
